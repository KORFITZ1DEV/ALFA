...
const anim_0 = new MoveAnimation(myrect1myrect1,200,animDuration);
const anim_1 = new WaitAnimation(delay);
const anim_2 = new MoveAnimation(myrect2myrect2,300,animDuration);
const anim_3 = new MoveAnimation(myrect1myrect1,-200,animDuration);
const anim_4 = new WaitAnimation(delay);
const anim_5 = new MoveAnimation(myrect2myrect2,-200,animDuration);
const myrect3 = new Rectangle(200,150,20,20);

const anim_6 = new MoveAnimation(myrect3myrect3,200,animDuration);
