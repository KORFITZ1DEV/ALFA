...
async function main() {
	...
	let var_myRect1=new Rect(0,0,var_len,var_len)

	let var_myRect2=new Rect(50,100,var_len,var_len)
...
; var_i < 4; var_i++){
		...
		await var_myRect1.move(var_offsetX,0,var_duration);

		await var_myRect1.move(0,var_offsetY,var_duration);
if (var_i <= 2){
			
			await moveParal([				
				() => var_myRect2.move(var_offsetX,0,var_duration),
				() => var_myRect2.move(0,100,var_duration),			
			]);
