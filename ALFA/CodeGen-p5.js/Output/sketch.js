...
const anim_0 = new MoveAnimation(const anim_1 = new WaitAnimation(const anim_2 = new MoveAnimation(const anim_3 = new MoveAnimation(const anim_4 = new WaitAnimation(const anim_5 = new MoveAnimation(const myrect3 = new Rectangle(
const anim_6 = new MoveAnimation(const seqAnim = new SeqAnimation([anim_0,anim_1,anim_2,anim_3,anim_4,anim_5,anim_6]);
